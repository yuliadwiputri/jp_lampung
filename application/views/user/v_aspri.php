    <div class="features">
        <div class="container">
            <center>
                <br><br><br>
                <h1 class="section_title">JP-ASPRI</h1>
                <h2 class="section_title">Asuransi Kecelakaan Diri</h2>
                    ...
                    <div class="section_title_container text-justify">
                        <div class="section_subtitle">
                            <div class="card" style="width: 27rem;">
                                <img src="<?= base_url('template\img\jp_aspri.png') ?>" class="card-img-top" alt="...">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card border mb-3 shadow-sm p-3 mb-5 bg-white rounded" style="max-width: 100%;">
                        <div class="card-body">
                            <div class="card-body text-justify">
                                <p class="card-text fs-6">Kecelakaan, dapat terjadi dimana saja, dan bersifat tiba-tiba. Tidak hanya di jalan raya tapi juga di rumah, di tempat kerja, pusat keramaian atau banyak tempat lainnya. Anda tidak akan pernah menduga apa yang akan terjadi.</p>
                                <p class="fs-6">JP-ASPRI adalah solusi yang tepat untuk memberikan perlindungan bagi Anda, orang-orang yang Anda sayangi, karyawan Anda ataupun rekan-rekan Anda dari risiko kecelakaan, karena JP-ASPRI tidak hanya melindungi di tempat kerja atau di sekolah, tetapi selama 24 jam dimana saja berada. Jangan menunggu waktu percayakan sepenuhnya perlindungan asuransi kecelakaan pribadi pada JP-ASPRI, produk asuransi terpercaya dari JRP-INSURANCE.</p><br>
                                ...
                                <div class="card shadow p-3 mb-2 bg-white rounded">
                                    <div class="card-body">
                                        ...
                                        <ul style="list-style-type:circle">
                                            <li class="fs-6">Tertanggung sesegera mungkin melaporkan/menyampaikan keterangan tertulis mengenai kerugian yang terjadi dengan tidak merubah/merusak objek yang mengalami kerugian.</li>
                                            <li class="fs-6">Pengajuan klaim dilakukan dengan:
                                                - Mengisi formulir Laporan Klaim Asuransi Kecelakaan Diri (LK1) <br>
                                                ...
                                                - Dokumen pendukung lainnya yang diperlukan <br>
                                            </li>
                                        </ul>
                                        </p>
                                    </div>
                            ...
                            <div class="flip-card-inner">
                                ...
                                <div class="flip-card-back text-left" style="line-height: 2em;">
                                    <ul style="list-style-type:circle" class="p-5">
                                        ...
                                        <li>SANTUNAN DITERIMA LEBIH DARU SATU KALI, selama kartu peserta masih berlaku</li>
                                        <li>Identitas KARTU PESERTA ASURANSI EKSKLUSIF</li>
                                    </ul>
                            ...
                            <div class="flip-card-inner">
                                ...
                                <div class="flip-card-back text-left" style="line-height: 2em;">
                                    <ul style="list-style-type:circle" class="p-4">
                                        ...
                                        <li>Tertanggung bertindak sebagai pengemudi kendaraan bermotor tanpa memiliki SIM (surat izin mengemudi) yang sah.</li>
                                        <li>Mengikuti Latihan Militer.</li>
                                        <li>Menggunakan obat-obatan terlarang, Narkotika, dan Obat sejenis yang dapat mengakibatkan kematian</li>
                                        <li>Penyakit Covid19</li>
                                    </ul>
