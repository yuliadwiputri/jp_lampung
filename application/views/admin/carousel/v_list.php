<div class="col-lg-12">
    ...
    ?> <a href="<?= base_url('carousel/add1') ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Add</a>
    <?php } ?>
    <?php
    foreach ($carousel as $key => $v) {
                    ...
                    <?php } ?>
                      ...
                      <tr>
                        ...
                        <td>
                        <?php if (!empty($carousel2)) {
        echo '<a href="#" class="btn btn-primary disabled" ><i class="fa fa-plus"></i> Add</a>';
    } else {
    ?> <a href="<?= base_url('carousel/add12') ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Add</a>
    <?php } ?>
    <?php
    foreach ($carousel2 as $key => $v) {
      ...
      <?php
                    ...
                    <?php } ?>
                        ...
                        <tr>
                            ...
                            <!-- <td><?= $no++; ?></td> -->
                            <td>
                            <?php if (!empty($carousel3)) {
        echo '<a href="#" class="btn btn-primary disabled" ><i class="fa fa-plus"></i> Add</a>';
    } else {
    ?> <a href="<?= base_url('carousel/add13') ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Add</a>
    <?php } ?>
    <?php
    foreach ($carousel3 as $key => $v) {
                    ...
                    <?php } ?>
                        ...
                        <tr>
                            ...
                            <!-- <td><?= $no++; ?></td> -->
                            <td>
                            <?php if (!empty($carousel4)) {
        echo '<a href="#" class="btn btn-primary disabled" ><i class="fa fa-plus"></i> Add</a>';
    } else {
    ?> <a href="<?= base_url('carousel/add14') ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Add</a>
    <?php } ?>
    <?php
    foreach ($carousel4 as $key => $v) {
