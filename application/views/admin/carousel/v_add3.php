           ...
           echo form_open_multipart('carousel/add');
            ?>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="file" name="foto_carousel3" placeholder="Foto" required>
                    <!-- <p class="help-block">Example block-level help text here.</p> -->
                </div>
                <div class="form-group">
                    <label>Keterangan</label>
                    <input class="form-control" type="text" name="keterangan3" placeholder="keterangan">
                </div>
                              <div class="form-group" >
