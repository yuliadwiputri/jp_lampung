<div class="col-lg-12">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
           ...
           echo form_open_multipart('jpAspri/add');
            ?>
                
                <div class="form-group">
                    <label>Foto</label>
                    <input class="form-control" type="file" name="foto_jpAspri" placeholder="Foto" required>
                ...
                <div class="form-group">
                   ...
                   <textarea name="kelebihan" id="editor6"  ></textarea>
                </div>
                <div class="form-group">
